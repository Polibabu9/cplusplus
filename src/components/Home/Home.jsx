            ...
            <div className="row justify-content-center align-items-center">
                <div className="col-md-7 d-flex align-items-center text-md-start">
                    <div>
                        ...
                        <p className="lead">Explore tutorials, references, and expert articles to become a C++ pro with <span>CPlusPlus.com</span></p>
                        <a href="/tutorials" className="btn btn-primary btn-lg" id="start-learn">Start Learning</a>
                    </div>
                </div>
                ...
                <div className="col-md-4">
                    <div className="card h-100 d-flex flex-column justify-content-center text-center">
                        <div className="card-body">
                            ...
                            <a href="/tutorials" className="btn btn-primary mt-auto">Tutorials</a>
                        </div>
                    </div>
                </div>
                <div className="col-md-4">
                    <div className="card h-100 d-flex flex-column justify-content-center text-center">
                        <div className="card-body">
                            ...
                            <a href="/references" className="btn btn-primary mt-auto">References</a>
                        </div>
                    </div>
                </div>
                <div className="col-md-4">
                    <div className="card h-100 d-flex flex-column justify-content-center text-center">
                        <div className="card-body">
                            ...
                            <a href="articles" className="btn btn-primary mt-auto">Articles</a>
                        </div>
                    </div>
                </div>
            </div>
